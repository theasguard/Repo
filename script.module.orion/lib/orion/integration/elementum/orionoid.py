...
class Orionoid:
	...
	Id = 'orion'
	Name = Orion.Name
	Key = 'VkdsQ1MwbEZOR2RXYVVKTlNVVnZaMUo1UWxoSlJWRm5VVk5DU1VsRlVXZFZlVUpTU1VWTloxVjVRbFpKUmxGblZHbENSa2xGVldkVGVVSkpTVVZWWjFacFFraEpSVzluVW1sQ1NFbEVXV2RUZVVKSQ=='
	...
	@classmethod
	def _error(self):
		OrionTools.error('ELEMENTUM ORION ERROR')
	...
	def _name(self, data):
		...
		name += '[%s]' % quality # Otherwise Elementum incorrectly detects the quality.
		return name
	...
	def streams(self, filtering):
		try:
			addon = OrionTools.addon('script.elementum.burst')
