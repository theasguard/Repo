...
class source:
	...
	def __init__(self):
		self.addon = xbmcaddon.Addon('plugin.video.fen')
		self.addonScrapers = xbmcaddon.Addon('script.module.tikiscrapers')
		self.priority = 1
		...
		self.key = 'VTJsQ1EwbEZkMmRPZVVKTlNVVlJaMVpwUVROSlJYZG5VME5DUkVsRlZXZFZVMEpNU1VWeloxRnBRVFJKUlUxblZHbENSMGxGZDJkUlUwSkZTVVZqWjFSRFFUTkpSRkZuVlhsQ1MwbEZSV2RWYVVKSg=='
	...
	def _error(self):
		...
		xbmc.log('FEN ORION [ERROR]: ' + parameters, xbmc.LOGERROR)
