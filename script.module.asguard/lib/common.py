...
def filter_host(host):
    if host not in ['example.com', 'allvid.ch', 'anime-portal.org', 'anyfiles.pl',
                    'www.apnasave.club', 'archive.is', 'castamp.com', 'clicknupload.com', 'clicknupload.me',
                    'clicknupload.link', 'cloud.mail.ru', 'cloudy.ec', 'cloudy.eu', 'cloudy.sx',
                    'cloudy.ch', 'cloudy.com', 'daclips.in', 'daclips.com', 'dailymotion.com',
                    'ecostream.tv', 'exashare.com', 'uame8aij4f.com', 'filescdn.net',
                    ...
                    'gvideo', 'hugefiles.net', 'indavideo.hu', 'kingfiles.net', 'mail.ru',
                    ...
                    'sendvid.com', 'streamcherry.com', 'streamplay.to', 'turbobit.net', 'thevid.net',
                    'thevideo.me', 'vev.io', 'oneload.site', 'trollvid.net', 'trollvid.io',
                    'mp4edge.com', 'tudou.com', 'tune.pk', 'uploadboy.ir', 'uploadx.org', 'uploadz.co',
                    ...
                    'vivo.sx', 'vk.com', 'vshare.eu', 'wayupload.com', 'watchonline.to',
                    ...
                    'megamp4.net', 'mp4engine.com', 'mp4upload.com', 'myvidstream.net', 'megaupload.nz',
                    ...
                    'solidfiles.com', 'speedplay3.pw', 'speedplayy.site', 'speedvid.net',
...
def get_rd_domains():
    ...
    cache_location = os.path.join(
            xbmc.translatePath(xbmcaddon.Addon("plugin.video.asguard").getAddonInfo('profile')).decode('utf-8'),
            'asguardcache.db')
    try:
