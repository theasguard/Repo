...
class Scraper(scraper.Scraper):
    OPTIONS = ['http://www1.xmovies8.fm', 'https://putlockerhd.co', 'https://afdah.org', 'https://watch32hd.co']
    ...
    def resolve_link(self, link):
        link = link.split('|', 1)[0]
        html = self._http_get(link, allow_redirect=True, method='HEAD', cache_limit=0)
