...
import cache
from asguard_lib import client, control, db_utils


class CONSUMETAPI:
    def __init__(self):
        self.baseUrl = 'http://192.168.1.70:3000/'
    ...
    #     show_meta = db_utils.get_show_meta(anilist_id)
    #     kodi_meta = pickle.loads(db_utils.get_show(anilist_id).get('kodi_meta'))
    #     if show_meta:
    ...
    #     episodes = db_utils.get_episode_list(int(anilist_id))
