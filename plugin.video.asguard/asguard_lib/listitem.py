...
class _ListItemInfoTagVideo(_ListItemInfoTag):
    ...
    _tag_attr = {
        ...
        'genre': {'attr': 'setGenres', 'convert': lambda x: x.split(', ') if isinstance(x, str) else ([x] if not isinstance(x, (list, tuple)) else x), 'classinfo': (list, tuple, str)},
        ...
        'castandrole': {'skip': True},
        'director': {'attr': 'setDirectors', 'convert': lambda x: x if isinstance(x, (list, tuple)) else [x], 'classinfo': (list, tuple)},
        ...
        'studio': {'attr': 'setStudios', 'convert': lambda x: list(x.values()) if isinstance(x, dict) else (x if isinstance(x, (list, tuple)) else [x]), 'classinfo': (list, tuple, dict, str)},
        'tagline': {'attr': 'setTagLine', 'convert': str, 'classinfo': str},
        'writer': {'attr': 'setWriters', 'convert': lambda x: x if isinstance(x, (list, tuple)) else [x], 'classinfo': (list, tuple)},
        ...
        'credits': {'attr': 'setWriters', 'convert': lambda x: x if isinstance(x, (list, tuple)) else [x], 'classinfo': (list, tuple)},
        ...
        'imdb_id': {'attr': 'setIMDBNumber', 'convert': str, 'classinfo': str},
        'tmdb_id': {'attr': 'setUniqueIDs', 'convert': lambda x: {'tmdb': x}, 'classinfo': dict},
        'tvdb_id': {'attr': 'setUniqueIDs', 'convert': lambda x: {'tvdb': x}, 'classinfo': dict},
        'trakt_id': {'attr': 'setUniqueIDs', 'convert': lambda x: {'trakt': x}, 'classinfo': dict},
        'slug': {'attr': 'setUniqueIDs', 'convert': lambda x: {'slug': x}, 'classinfo': dict},
        'TotalEpisodes': {'attr': 'setTotalEpisodes', 'convert': int, 'classinfo': int},
        'WatchedEpisodes': {'attr': 'setWatchedEpisodes', 'convert': int, 'classinfo': int},
        'UnWatchedEpisodes': {'attr': 'setUnWatchedEpisodes', 'convert': int, 'classinfo': int},
        'TVShowTitle': {'attr': 'setTvShowTitle', 'convert': str, 'classinfo': str},
    }
