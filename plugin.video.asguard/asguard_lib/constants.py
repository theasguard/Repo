...
MODES = __enum(
    ...
    SIMKL_SEARCH='simkl_search', BROWSE_ANIME='browse_anime', SIMKL_AUTH='simkl_auth', SIMKL_TRENDING='simkl_trending', SIMKL_POPULAR='simkl_popular', SIMKL_EPISODES='simkl_episodes', RESTART_IMAGE_PROXY='restart_image_proxy')
...
QUALITIES = __enum(LOW='Low', MEDIUM='Medium', HIGH='High', HD720='HD720', HD1080='HD1080', HD4K='HD4K')
